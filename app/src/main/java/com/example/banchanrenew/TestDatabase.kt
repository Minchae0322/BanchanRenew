...
@Database(entities = [IRDNTDescription::class, Recipe::class ,Ingredient::class, GramOfUnit::class, Dish::class, EssentialIngredients::class],  version = 6, exportSchema = true)
